<aside class="w-64 bg-[#4C9A8B] text-white flex flex-col min-h-screen">
    ...
    <nav class="flex-1 px-3 py-4 space-y-1 text-[15px]">
        ...
        <!-- Pengguna -->
        <div class="flex items-center justify-between px-4 py-3 rounded-lg hover:bg-white/10 cursor-pointer">
    ...
    <div class="px-4 pb-6">
        ...
        <form method="POST" action="{{ route('logout') }}">
            ...
            <button class="flex items-center gap-3 px-4 py-3 rounded-lg w-full hover:bg-white/10">
